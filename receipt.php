...
<head>
   ...
   <title>Customer's Receipt - Hky integrated</title>
   <!-- Link favIcon -->
...
<section class="wrapper">
   <h2 class="store-name">HKY INTEGRATED CONCEPT</h2>

   <div class="address">IBB Road, Gidan Habu Mai Suger, Kano State. <br/>
     <?php date_default_timezone_set('Africa/Lagos'); ?>
     Tel: 07039569458. Date: <?= Date("d/m/Y H:i a") ?>
   </div> 

   <div class="trans-id">TRANS-ID: HKY<?= @$_SESSION["trans_id"] ?></div> <br/>
