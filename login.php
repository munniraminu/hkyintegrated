...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">sign in</h4>
	<p class="">Welcome to your account.</p>
...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle">create HKY new account</h4>
	<p class="text title-tag-line">Create HKY Shopping account.</p>
...
<div class="form-group">
	...
	<div class="checkbox">
		...
		Have a Fashion Products.
		</label>
		<label class="checkbox">
		Track your orders easily.
		</label>
		<label class="checkbox">
      Have a Receipt of Payment.
		</label>
		<label class="checkbox">
