...
<script>
	function printPage()
	{
		window.print();
	         ...
	         <h2 align="center">HKY RECEIPT OF PAYMENT</h2>
...
$_SESSION['pid']=$pdtid;
		...
		<h4 align="center">Thanks for shopping with us</h4>

           <h4 align="center">    <button onclick="printPage()"> PRINT RECEIPT</button>  </h4>
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Customer Address</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Customer Address<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Customer State  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Customer City <span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Customer Pincode <span>*</span></label>
