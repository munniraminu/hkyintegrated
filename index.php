...
<section class="main-content">
    ...
    <header class="page-header">
      <div class="img-wrapper">
         ...
         </a>warning:: your outstanding payment is ₦64,000, you paid ₦114,000. <br> pay before 7/03/2026 to avoid penalty!!!
      </div>
      <h3>WELCOME TO HKY INTEGRATED CONCEPT LTD.</h3>
    ...
    <br/>
     ...
     <section class="activity">
      ...
      <a href="./cashier_login/cashier_login.php">
	    ...
	    <br/><br/><br/>
         <footer class="footer">
           Hky integrated <span>&copy;2026 - <?= Date('Y') ?></span>
         </footer>
</section>
